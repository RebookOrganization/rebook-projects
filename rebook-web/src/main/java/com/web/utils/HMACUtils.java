...
public class HMACUtils {
   ...
   */
  public static String HMacBase64Encode(final String algorithm, final String key,
      final String data) {
   ...
   */
  public static String HMacHexStringEncode(final String algorithm, final String key,
      final String data) {
    byte[] hmacEncodeBytes = HMacEncode(algorithm, key, data);
    if (hmacEncodeBytes == null) {
      return null;
